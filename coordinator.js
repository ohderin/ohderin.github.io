...
for (var i = 0; i < numWorkers; i++) {
  ...
  worker.postMessage({ cmd: "setPassToCrack", data: "ca00a08cc6300b9eef41da408b2e3da9" })

  // Start worker
  worker.postMessage({ cmd: "performCrack", data: {start: i, hop: numWorkers} })
}

status("Searching for password match for hash 'ca00a08cc6300b9eef41da408b2e3da9'.")
